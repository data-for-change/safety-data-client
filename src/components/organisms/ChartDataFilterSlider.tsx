		...
		<div className='chart-range-slider-container' style={styles.container}>
			<div style={styles.labelContainer}>
				<div style={styles.inputsWrapper}>
					<span style={styles.labelText}>{t('data_range')}:</span>
					<input
						type='number'
...
const css = `
  ...
  .chart-range-slider-container input[type=number]::-webkit-inner-spin-button,
  .chart-range-slider-container input[type=number]::-webkit-outer-spin-button {
    -webkit-appearance: none;
    margin: 0;
  }
  .chart-range-slider-container input[type=number] {
    -moz-appearance: textfield;
  }
  .chart-range-slider-container input[type=number]:focus {
    border-color: #3b82f6;
